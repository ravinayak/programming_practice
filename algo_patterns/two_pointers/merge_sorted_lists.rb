...
list1 = List.prepare_list(input_arr: input_arr_one)
list2 = List.prepare_list(input_arr: input_arr_two)
list1.traverse_list
list2.traverse_list
# Now list1 and list2 are basically linked lists which can be merged using
# normal code for merge_sorted_linked_lists
